...
DSN ?= avnadmin:AVNS_-wk8zD1Ll7Yq5suRH8T@tcp(mysql-playground-ghalmas-lab.c.aivencloud.com:10634)/loan?parseTime=true
GOOSE_OPTIONS := -dir $(MIGRATION_DIR) mysql "$(DSN)"
